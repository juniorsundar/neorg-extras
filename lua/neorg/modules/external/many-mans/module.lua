...
module.public = {
    ...
    ["buff-man"] = {
        ...
        ---@return integer buffer_number
        ---@return integer window_number
        create_capture_buffer = function(buffer_lines, split_kind, capture_kind)
            ...
            vim.api.nvim_buf_set_keymap(module.public["buff-man"].buf, "n", "<C-c><C-c>", "", {
                noremap = true,
                silent = true,
                callback = function()
                    module.public["buff-man"].write_capture_to_journal(capture_kind)
                end,
            })
            return module.public["buff-man"].buf, module.public["buff-man"].win
        end,
